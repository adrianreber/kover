...
string server::get_site() { return site; }

string server::get_proto() { return proto; }

int server::get_port() { return port; }

string server::get_path() { return path; }

string server::get_latitude() { return latitude; }

string server::get_longitude() { return longitude; }

string server::get_description() { return description; }
