...
pkgdatadir = $(datadir)/kover
pkglibdir = $(libdir)/kover
pkgincludedir = $(includedir)/kover
...
PYTHONINC = @PYTHONINC@
PYTHONLIB = @PYTHONLIB@
QT_INCLUDES = -I/usr/lib/qt-2.2.1/include
QT_LDFLAGS = -L/usr/lib/qt-2.2.1/lib
RANLIB = ranlib
USE_NLS = yes
VERSION = 0.4
...
all_includes = -I/usr/include/kde -I/usr/lib/qt-2.2.1/include -I/usr/X11R6/include
all_libraries = -L/usr/lib -L/usr/lib/qt-2.2.1/lib -L/usr/X11R6/lib
install_root = 
kde_appsdir = 
kde_bindir = 
kde_cgidir = 
...
kde_toolbardir = 
kde_wallpaperdir = 
qt_includes = /usr/lib/qt-2.2.1/include
qt_libraries = /usr/lib/qt-2.2.1/lib
